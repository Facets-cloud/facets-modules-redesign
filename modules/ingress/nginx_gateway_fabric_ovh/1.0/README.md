# NGINX Gateway Fabric (OVH)

Kubernetes Gateway API implementation for OVH Managed Kubernetes clusters.

## Overview

This module deploys **NGINX Gateway Fabric** on OVH Managed Kubernetes. It is a thin cloud-specific wrapper around the base utility module, adding OVH LoadBalancer annotations for load balancer flavor configuration.

### Cloud-Specific Behavior

| Setting | Behavior |
|---------|----------|
| **Load Balancer** | OVH Load Balancer (small flavor) |
| **LB Annotation** | `loadbalancer.ovhcloud.com/flavor: small` (always set) |
...
{
  "kind": "ingress",
  "flavor": "nginx_gateway_fabric_ovh",
  "version": "1.0",
  "spec": {
    "private": false,
...
|-------|------|---------|-------------|
| `private` | boolean | `false` | Use private load balancer |
