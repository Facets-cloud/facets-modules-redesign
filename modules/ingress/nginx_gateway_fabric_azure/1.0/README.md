# NGINX Gateway Fabric (Azure)

Kubernetes Gateway API implementation for Azure AKS clusters.

## Overview

This module deploys **NGINX Gateway Fabric** on Azure Kubernetes Service (AKS). It is a thin cloud-specific wrapper around the base utility module, adding Azure Load Balancer annotations for internal/external load balancer support.
...
| **Private LB** | Sets `service.beta.kubernetes.io/azure-load-balancer-internal: "true"` |
| **Public LB** | Sets `service.beta.kubernetes.io/azure-load-balancer-internal: "false"` |
...
{
  "kind": "ingress",
  "flavor": "nginx_gateway_fabric_azure",
  "version": "1.0",
  "spec": {
    "private": false,
...
Sets `service.beta.kubernetes.io/azure-load-balancer-internal: "true"` on the LoadBalancer service.
...
|-------|------|---------|-------------|
| `private` | boolean | `false` | Use internal Azure Load Balancer |
...
|-------|------|----------|-------------|
| `kubernetes_details` | `@facets/azure_aks` | Yes | AKS cluster connection + providers |
