...
locals {
  ...
  #
  # service_account_arn is likewise chart-owned: this flavor creates no cloud
  # identity at all. Bind one with the dedicated workload-identity intent for
  # your cloud, then inject its annotation through helm_values.
  output_attributes = {
