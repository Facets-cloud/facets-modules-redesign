...
resource "kubernetes_namespace" "mysql_cluster" {
...
module "mysql_cluster" {
  ...
  release_name = "mysql-${local.cluster_name}-${substr(var.inputs.kubeblocks_operator.output_interfaces.output.release_id, 0, 8)}"
