locals {
  output_attributes = {
    ...
    private_ip_range       = google_compute_global_address.private_ip_range.address
    vpc_peering_connection = google_service_networking_connection.private_vpc_connection.peering
  }
  output_interfaces = {
