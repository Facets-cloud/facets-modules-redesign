...
resource "aws_elasticache_replication_group" "redis" {
  replication_group_id = "${var.instance_name}-${var.environment.unique_name}"
  ...
  snapshot_arns = var.instance.spec.restore_config.restore_from_snapshot ? [var.instance.spec.restore_config.snapshot_arns] : null
  ...
  lifecycle {
    ...
    ignore_changes = [
      # Ignore changes to snapshot_arns after initial creation
      snapshot_arns,
    ]
  }
